...
const ApplicationBody = () => {
    ...
    const handleItemButtonPressed = (props) => {
    ...
    return(
        <div className={styles.container}>
            ...
            <div className={styles.leftSection}>
                {(isAddMessageSectionOpen === true) ? <GetInput onItemButtonPress={handleItemButtonPressed} addItem={addNewItem}/> : <ItemButton onItemButtonPress={handleItemButtonPressed} buttonText={"Message"} buttonIcon={"fa-regular fa-comment"}/>}
                {(isAddDateAndTimeSectionOpen === true) ? <GetDateInput onItemButtonPress={handleDateAndTimeButtonPressed} addItem={addNewItem}/> : <ItemButton onItemButtonPress={handleDateAndTimeButtonPressed} buttonText={"Date and Time"} buttonIcon={"fa-regular fa-calendar"}/>}                
            </div>
